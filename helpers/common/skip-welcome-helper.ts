...
export async function skipWelcomeHelper(
  ...
  try {
    ...
    const loadingText = page.getByText(/The page is currently loading|Die Seite wird gerade geladen/i);
    ...
    const goStraightText = translations.additional.goStraightToWorkspace || 'Go straight to my workspace'
