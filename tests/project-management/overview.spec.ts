...
test.describe('Project management overview', () => {
    ...
    test('Verfify the add project button and create project button', async ({ page }) => {
            Allure.addDescription(
    ...
    test('Validate the title input field for character counts in add projct modal', async ({ page }) => {
            Allure.addDescription(
    ...
    test('Validate the navigation to selected project overview through cicking on search icon and edit the project details', async ({ page }) => {
            Allure.addDescription(
    ...
    test('Validate the hidden filter functionality in overview', async ({ page }) => {
      Allure.addDescription(
        'Verifies that project is hidden succssesfully.'
     )
      await Allure.step(
    ...
    test('Verify the navigation to personnel allocation page when clicked on arrow icon', async ({ page }) => {
