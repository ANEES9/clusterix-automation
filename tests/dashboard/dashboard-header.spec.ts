...
test.describe('Dashboard Item Collapse Tests', () => {
  ...
  test('Validate Time Tracking Navigation on Button Click', async ({ page }) => {
    ...
    const timeTrackingButton = page.locator('button.AppBadge-module_wrapper__ctDKc[title="Time Tracking"]');
  ...
  test.skip('Verify item collapse functionality', async ({ page }) => {
