...
test.describe('Company Page Test Suite', () => {
 ...
 interface SearchData { searchTerm: string}
...
test('Verify Search, Pagination, and Data Validation with Flexible Page Check', async () => {
  Allure.addSeverity('critical')
  Allure.addTag('search')
  Allure.addDescription('Verify Search, Pagination, and Data Validation with Flexible Page Check')
...
test('Verify Backwards Navigation Functionality', async () => {
  ...
  await companyPage.verifyPreviousPageNavigation(startingPage, pagesToNavigateBack)
})
...
test('verify child row label matches expanded rows', async () => {
  ...
  test('Verify all filter elements are visible', async () => {
    ...
    Allure.addDescription('Test to verify that filter elements are visible and functional.' )
  ...
  test('Verify country selection from nested dropdown', async () => {
    Allure.addSeverity('critical')
    Allure.addTag('filter')
    Allure.addDescription('Test to verify that nested dropdown is visible and functional.'  )
    await companyPage.filterButton.click()
