...
export class ProjectOverview {
  ...
  constructor(page: Page, locale: string) {
    ...
    this.projectStartCalendar = page.getByRole('button', { name: 'Project start' })
    ...
    this.deleteToasterMessage = page.locator('text=projects deleted successfully')
    ...
    this.allocationPageLoaded = page.getByRole('heading', { name: 'Personnel Allocation' })
    ...
    this.revealToasterMessage = page.locator('text=Project revealed successfully.')
} 
...
async verifyHeadingInNewPage(newPage: Page) {
  await Allure.step('Verify the heading on the new page of personnel allocation', async () => {
    const allocationPageLoaded = newPage.locator('h1', { hasText: 'Personnel Allocation' })
