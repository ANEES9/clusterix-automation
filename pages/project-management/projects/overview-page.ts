...
export class OverviewPage {
  ...
  private projectListBody: Locator
    ...
    constructor(page: Page, locale: string) {
        ...
        this.viewButton = page.locator('button.Bar-module_part__CpFuS:nth-of-type(1)')
        this.tileViewButton = page.locator('button:has(span:has-text("Tile view"))')
        this.tileViewCardHeader = page.locator('.project-management-overview-tilesview')                     //('div.project-management-overview-tilesview-status-cards-card-header')
        ...
        this.filteredProjectsHeader = page.locator('div.project-management-overview-title b')
        this.addProjectButton = page.getByText('Add project')
        this.selectProjectTypePlaceholder = page.locator('input[placeholder="Please select project type"]')
        this.selectProjectType =  page.getByText('Agile Software Projects')
        this.shortTitleInput = page.locator('input[placeholder="Please enter short title"]')
        this.shortTitleInputCharacterCount = page.locator('div:has(input[placeholder="Please enter short title"]) .characters-counter-danger').first()
        this.projectTitleInput = page.locator('input[placeholder="Please enter title"]')
        ...
        this.projectCreatedSuccessMessage = page.getByText('Project created successfully.')
        this.projectTitleInputCharacterCount = page.locator('input[placeholder="Please enter title"].characters-counter-danger').nth(1)
        ...
        this.selectShowProjectsOption = page.getByRole('button', { name: 'Show projects' })
...
async clickCreateProjectButton() {
    await Allure.step('Click on create project button', async () => {
        ...
        await expect(this.projectCreatedSuccessMessage).toHaveText('Project created successfully.')
