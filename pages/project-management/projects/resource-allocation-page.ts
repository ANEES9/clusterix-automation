...
export class ResourceAllocation {
  ...
  constructor(page: Page, locale: string) {
    ...
    this.allProjectsFilter = page.getByPlaceholder(
      this.translations.common['all_projects']
    )
    this.validateDropdown = page.getByRole('textbox', {
      name: 'Search',
      exact: true,
    })
    this.scrollableDivLocator = page.locator(
      'div._list_nwlud_1._list_m_nwlud_31._list_withSearch_nwlud_47'
    )
    this.selectProjectname = page.locator(
      `._list_nwlud_1._list_m_nwlud_31._list_withSearch_nwlud_47 button[type="button"] span:has-text("${addProjectData.projectShortTitle}")`
    )
    this.projectListVisible = page.getByText(
      this.translations.crossProjectData.assigned_employees
    )
    this.projectTitleVisiblePersonnelAllocation = page.locator(
      `.pp25_iayy8XC2f7IU9mr span:has-text("${addProjectData.projectShortTitle}")`
    )
    this.assignFirstEmployee = page
      .locator('.pZFG9RiP1t8mFP2wDBU1 > div > span')
      .first()
    this.assignSecondEmployee = page
      .locator('.pZFG9RiP1t8mFP2wDBU1 > div > span')
      .nth(2)
    this.deassignConfirmModal = page.locator(
      `div.confirm-modal-container-body-message:has-text("${this.translations.crossProjectData.confirm_remove_employee}")`
    )
    this.deassignConfirmButton = page.getByRole('button', {
      name: this.translations.crossProjectData['confirm'],
    })
    this.searchForEmployeeFilter = page.getByPlaceholder(
      this.translations.crossProjectData['search_for_employee']
    )
    this.contractorAllocationButton = page
      .locator('._sidebarSubMenuButton__content_16zcl_834')
      .nth(1)
    this.contractorAllocationPageLoaded = page.getByText(
      this.translations.crossProjectData.assign_contractors_to_each_project
    )
    this.expandSideBar = page.locator(
      'button._collapseButton_16zcl_522._collapseButton_collapsed_16zcl_552 svg._collapseButton__icon_16zcl_543'
    )
    ...
    this.newContractorButton = page.getByRole('button', {
      name: this.translations.crossProjectData.new_contractor,
    })
    this.newContractorModal = page
      .locator(
        `div.styles-module_modal__f2oC3 :has-text("${this.translations.crossProjectData.new_contractor}")`
      )
      .nth(2)
    this.closeNewContractorModal = page.locator(
      'button.styles-module_headerCloseButton__x2ELS'
    )
    this.contractorNameInput = page
      .locator('div.vkF5gGQNEeHQAep9w6QY input')
      .first()
    this.contractorCountryField = page
      .locator('div.vkF5gGQNEeHQAep9w6QY input')
      .nth(1)
    this.contractorCounntryDropdown = page.locator('._list_dd6fb_14')
    this.selectContractorCountry = page.getByRole('button', {
      name: this.translations.crossProjectData.table.country_name_algeria,
    })
    this.contractorBussinessForm = page
      .locator('div.vkF5gGQNEeHQAep9w6QY input')
      .nth(2)
    this.contractorBusinessFormDropdown = page.locator('._list_dd6fb_14')
    this.selectBusinessForm = page.getByRole('button', {
      name: 'Société par actions simplifiée',
    })
    this.contractorTaxNumber = page
      .locator('div.vkF5gGQNEeHQAep9w6QY input')
      .nth(3)
    this.addContractorButton = page.getByRole('button', {
      name: this.translations.crossProjectData.add_contractor,
    })
    this.validateContractorAdded = page.locator(
      `.I_blm39yUhplbgqn5xcj .kqVJPJT2tzbyJTJHOztF span:has-text("${newContractorDetails.contractorName}")`
    )
    this.updatedContractorName = page.locator(
      `.I_blm39yUhplbgqn5xcj .kqVJPJT2tzbyJTJHOztF span:has-text("${newContractorDetails.updatedContractorName}")`
    )
    this.projectTitleVisibleContractorAllocation = page.locator(
      `.fssMmTQFndvnV7bDxVzw span:has-text("${addProjectData.projectShortTitle}")`
    )
    this.otherCostAllocationButton = page
      .locator('._sidebarSubMenuButton__content_16zcl_834')
      .nth(2)
    this.otherCostAllocationPageLoaded = page.getByText(
      this.translations.crossProjectData.assign_other_costs_to_each_project
    )
    this.newOtherCostButton = page.getByText(
      this.translations.crossProjectData.add_new_cost
    )
    this.newOtherCostModal = page.getByText(
      this.translations.crossProjectData.new_other_cost
    )
    this.otherCostTitle = page.getByLabel(
      this.translations.crossProjectData.other_cost_input_field_label
    )
    this.saveOtherCostButton = page.getByRole('button', {
      name: this.translations.crossProjectData.save,
    })
    this.validateOtherCostAdded = page
      .locator(
        `.NEJbX_BxyZbYVchhOd2L span:has-text("${otherCostDetails.otherCostTitle}")`
      )
      .first()
    this.contractorMenuButton = this.validateContractorAdded.locator(
      'xpath=ancestor::div[@class="pPEq4CoPbkKDQBAU3rpf"]//div[@class="FZxW22iN9001LKva5sgO"]'
    )
    this.updatedContractorMenuButton = this.updatedContractorName.locator(
      'xpath=ancestor::div[@class="pPEq4CoPbkKDQBAU3rpf"]//div[@class="FZxW22iN9001LKva5sgO"]'
    )
    this.contractorMenuOptions = page.locator('._menu_1xinv_1')
    this.contractorEditButton = page.getByRole('button', {
      name: this.translations.crossProjectData.edit,
    })
    this.contractorDeleteButton = page.getByRole('button', {
      name: this.translations.crossProjectData.delete,
    })
    this.contractorEditModal = page.getByText(
      this.translations.crossProjectData.edit_contractor
    )
    this.editContractorNameSection = page.getByRole('heading', {
      name: newContractorDetails.contractorName,
    })
    this.updateContractor = page.getByRole('button', {
      name: this.translations.main['Update contractor'],
    })
    this.deleteContractorModal = page.locator(
      '.confirm-modal-container-body-title'
    )
    this.deleteContractor = page.getByRole('button', {
      name: this.translations.crossProjectData.delete,
    })
    this.searchForContractor = page.getByPlaceholder(
      this.translations.crossProjectData['search_for_contractor']
    )
    ...
    this.assignToProjectContractor = page
      .getByText(this.translations.crossProjectData.table.assign_to_project)
      .nth(5)
    this.deassignContractorFromProject = page.getByText(
      this.translations.crossProjectData.table.assigned_to_project
    )
    this.deassignContractorConfirmModal = page.getByText(
      this.translations.crossProjectData.confirm_remove_employee
    )
    this.deassignConfirmButtonContractor = page.getByRole('button', {
  ...
  async clcikAllProjectsFilter() {
    await Allure.step(
      ...
      async () => {
        ...
        await this.allProjectsFilter.waitFor({
          state: 'visible',
          timeout: 20000,
        })
  ...
  async validateAllProjectsFilter() {
    await Allure.step(
      ...
      async () => {
        ...
        expect(this.projectTitleVisiblePersonnelAllocation).toBeVisible({
          timeout: 20000,
        })
      }
    )
  ...
  async assignEmployeeToProject() {
    await Allure.step(
      'Click on Assign to Project for first employee',
      async () => {
        //await this.page.waitForTimeout(1000)
        await this.assignFirstEmployee.waitFor({
          state: 'visible',
          timeout: 3000,
        })
        ...
        expect(this.assignFirstEmployee).toHaveText(
          this.translations.crossProjectData.table.assigned_to_project
        )
  ...
  async deassignFirstEmployeeFromProject() {
    await Allure.step(
      'Remove the second employee after assigning ',
      async () => {
        ...
        expect(this.assignFirstEmployee).toHaveText(
          this.translations.crossProjectData.table.assign_to_project
        )
      }
    )
  }
  ...
  async searchForEmployeeFilterValidation() {
    await Allure.step(
      'Click on search for employee filter and validate its functioning',
      async () => {
  ...
  async expandSidebarContent() {
    await Allure.step(
      'Click on expand button and validate that sidebar content is loaded',
      async () => {
        await this.page.waitForLoadState('networkidle')
        this.page.waitForLoadState('domcontentloaded')
  ...
  async validateContractorAllocationPage() {
    await Allure.step(
      'Click on contractor allocation button and validate that page is loaded',
      async () => {
        await this.page.waitForLoadState('networkidle')
        this.page.waitForLoadState('domcontentloaded')
        await this.contractorAllocationPageLoaded.waitFor({
          state: 'visible',
          timeout: 10000,
        })
  ...
  async clickNewContractorButton() {
    await Allure.step(
      'Click on new contractor button and validate that modal is loaded',
      async () => {
        await this.page.waitForLoadState('networkidle')
        this.page.waitForLoadState('domcontentloaded')
        await this.newContractorButton.waitFor({
          state: 'visible',
          timeout: 5000,
        })
  ...
  async validateNewContractorModalAppears() {
    await Allure.step(
      'After clciking on add contractor button ensures modal apear',
      async () => {
  ...
  async closingNewContractorModal() {
    await Allure.step(
      'Click on cross icon to close the new contractor modal',
      async () => {
        await this.page.waitForLoadState('domcontentloaded')
  ...
  async clickAddContractor() {
    await Allure.step(
      'Click on add contractor button after filling all the details of contractor',
      async () => {
  ...
  async validateNewContractorAdded() {
    await Allure.step('Validate that new contractor is added', async () => {
      ...
      this.page.waitForLoadState('domcontentloaded')
      await this.page.waitForTimeout(2000)
      expect(this.validateContractorAdded).toContainText(
        newContractorDetails.contractorName
      )
    })
  }
  ...
  async clickContractorMenuButton() {
    await Allure.step(
      'Click on the menu option of newly added contractor',
      async () => {
  ...
  async clickEditContractor() {
    await Allure.step(
      'Validate clicking on eidt conractor button and ensure modal appears',
      async () => {
  ...
  async editContractorName() {
    await Allure.step('Editing the contrctor details', async () => {
      ...
      await this.contractorNameInput.fill(
        newContractorDetails.updatedContractorName
      )
    })
  }
  ...
  async validateupdatedContractorName() {
    await Allure.step('Validating the contractor updated name', async () => {
      await this.page.waitForLoadState('networkidle')
      this.page.waitForLoadState('domcontentloaded')
      await this.updatedContractorName.waitFor({
        state: 'visible',
        timeout: 5000,
      })
      //await this.page.waitForTimeout(2000)
      expect(this.updatedContractorName).toContainText(
        newContractorDetails.updatedContractorName
      )
  ...
  async updateContractorName() {
    await Allure.step(
      'Saving the updated details by clicking on update contractor button',
      async () => {
  ...
  async validateAllProjectsFilterForContractorAllocation() {
    await Allure.step(
      'Validate selected project is visible in the contractor allocation page',
      async () => {
        await this.page.waitForLoadState('networkidle')
        this.page.waitForLoadState('domcontentloaded')
        //await this.page.waitForTimeout(800)
        ...
        await this.selectProjectname.click()
        await this.allProjectsFilter.click()
        expect(this.projectTitleVisibleContractorAllocation).toBeVisible({
          timeout: 20000,
        })
      }
    )
  ...
  async assignContractorToProject() {
    await Allure.step('Assigning the contractor to project', async () => {
      ...
      await this.assignToProjectContractor.waitFor({
        state: 'visible',
        timeout: 5000,
      })
  ...
  async removingContractorFromProject() {
    await Allure.step('Removing the contractor from project', async () => {
      ...
      expect(this.deassignContractorConfirmModal).toBeVisible({
        timeout: 20000,
      })
  ...
  async clickDeleteContractor() {
    await Allure.step(
      'Click on delete contractor button and validate that modal is appeared',
      async () => {
        await this.page.waitForLoadState('networkidle')
        this.page.waitForLoadState('domcontentloaded')
        await this.updatedContractorName.scrollIntoViewIfNeeded()
        ...
        await this.deleteContractorModal.waitFor({
          state: 'visible',
          timeout: 50000,
        })
  ...
  async validateOtherCostAllocationPage() {
    await Allure.step(
      'After clicking on other cost allocation button and validate that page is loaded',
      async () => {
        await this.page.waitForLoadState('networkidle')
        this.page.waitForLoadState('domcontentloaded')
        expect(this.otherCostAllocationPageLoaded).toBeVisible({
          timeout: 30000,
        })
        // await this.page.waitForLoadState('domcontentloaded')
        // await this.page.waitForTimeout(1000)
  ...
  async clickNewOtherCostButton() {
    await Allure.step(
      'Click on new other cost button and validate that modal is appeared',
      async () => {
        await this.page.waitForLoadState('networkidle')
        this.page.waitForLoadState('domcontentloaded')
        // await this.page.waitForTimeout(1000)
        await this.newOtherCostButton.waitFor({
          state: 'visible',
          timeout: 5000,
        })
  ...
  async validateNewOtherCostModalAppears() {
    await Allure.step(
      'After clicking on new other cost button ensures modal should appear',
      async () => {
  ...
  async addNewOtherCost() {
    await Allure.step(
      'Click on New Cost button and add other cost',
      async () => {
  ...
  async validateAddedNewOtherCost() {
    await Allure.step('Validate the newly added other cost', async () => {
      this.page.waitForLoadState('domcontentloaded')
      //await this.page.waitForTimeout(1000)
      await this.validateOtherCostAdded.waitFor({
        state: 'visible',
        timeout: 10000,
      })
