...
export class AccountingBillsPage {
  private page: Page
  private translations: Record<string, any>

  public accountingBillsPageTitle: Locator
  ...
  constructor(page: Page, locale: string) {
    ...
    this.accountingBillsPageTitle = page.locator(
      `span:has-text('${this.translations.workflow_apps['4'].label}')`
    )
  ...
  /**
   * Navigate to the No Code Accounting Bills.
   * @param baseURL - The base URL of the application.
   */
  async gotoAccountingBills(baseURL: string | undefined) {
    await this.page.goto(`${baseURL}${APP_URLS.noCode.accountingBills.base}`)
    await this.page.waitForLoadState('networkidle')
  }

  getNoCodeAccountingBillsPageTitle(): Locator {
    return this.accountingBillsPageTitle
  }
  ...
  async validatePageTitle() {
    await expect(this.accountingBillsPageTitle).toBeVisible()
  }
