...
export class HumanResourcesPage {
  ...
  public humanResourcesPageTitle: Locator
  ...
  constructor(page: Page, locale: string) {
    ...
    this.humanResourcesPageTitle = this.page.locator(
      `span:has-text('${this.translations.workflow_apps['2'].label}')`
    )
  ...
  /**
   * Navigate to the No Code Human Resources.
   * @param baseURL - The base URL of the application.
   */
  async gotoHumanResources(baseURL: string | undefined) {
    await this.page.goto(`${baseURL}${APP_URLS.noCode.humanResources.base}`)
    await this.page.waitForLoadState('networkidle')
    await expect(this.humanResourcesPageTitle).toBeVisible()
  }

  getNoCodeHumanResourcesTitle(): Locator {
    return this.humanResourcesPageTitle
  }
