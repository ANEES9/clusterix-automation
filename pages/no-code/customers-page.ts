...
export class CustomersPage {
  ...
  constructor(page: Page, locale: string) {
    ...
    this.customersPageTitle = this.page.locator(
      `span:has-text('${this.translations.workflow_apps['1'].label}')`
    )
  ...
  /**
   * Navigate to the No Code Customers.
   * @param baseURL - The base URL of the application.
   */
  async gotoCustomers(baseURL: string | undefined) {
    await this.page.goto(`${baseURL}${APP_URLS.noCode.customers.base}`)
    await this.page.waitForLoadState('networkidle')
    await expect(this.customersPageTitle).toBeVisible()
  }

  getNoCodeCustomersTitle(): Locator {
